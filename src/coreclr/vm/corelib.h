...
DEFINE_FIELD_U(m_assembly,                 AssemblyBaseObjectInternal,     m_pAssembly)
...
DEFINE_CLASS_U(System,              Signature,          SignatureNativeInternal)
...
DEFINE_FIELD_U(_dateTimeInfo,      CultureInfoBaseObjectInternal,  _dateTimeInfo)
DEFINE_FIELD_U(_calendar,          CultureInfoBaseObjectInternal,  _calendar)
DEFINE_FIELD_U(_consoleFallbackCulture, CultureInfoBaseObjectInternal, _consoleFallbackCulture)
DEFINE_FIELD_U(_name,             CultureInfoBaseObjectInternal,  _name)
DEFINE_FIELD_U(_nonSortName,      CultureInfoBaseObjectInternal,  _nonSortName)
DEFINE_FIELD_U(_sortName,         CultureInfoBaseObjectInternal,  _sortName)
DEFINE_FIELD_U(_parent,           CultureInfoBaseObjectInternal,  _parent)
DEFINE_FIELD_U(_isReadOnly,        CultureInfoBaseObjectInternal,  _isReadOnly)
DEFINE_FIELD_U(_isInherited,      CultureInfoBaseObjectInternal,  _isInherited)
...
DEFINE_FIELD_U(_target,                    DelegateObjectInternal,   _target)
DEFINE_FIELD_U(_methodBase,                DelegateObjectInternal,   _methodBase)
DEFINE_FIELD_U(_methodPtr,                 DelegateObjectInternal,   _methodPtr)
DEFINE_FIELD_U(_methodPtrAux,              DelegateObjectInternal,   _methodPtrAux)
...
DEFINE_FIELD_U(_innerException,    ExceptionObjectInternal,    _innerException)
DEFINE_FIELD_U(_helpURL,           ExceptionObjectInternal,    _helpURL)
DEFINE_FIELD_U(_stackTrace,        ExceptionObjectInternal,    _stackTrace)
DEFINE_FIELD_U(_watsonBuckets,     ExceptionObjectInternal,    _watsonBuckets)
DEFINE_FIELD_U(_stackTraceString,  ExceptionObjectInternal,    _stackTraceString)
DEFINE_FIELD_U(_remoteStackTraceString, ExceptionObjectInternal, _remoteStackTraceString)
DEFINE_FIELD_U(_source,            ExceptionObjectInternal,    _source)
DEFINE_FIELD_U(_ipForWatsonBuckets,ExceptionObjectInternal,    _ipForWatsonBuckets)
DEFINE_FIELD_U(_xptrs,             ExceptionObjectInternal,    _xptrs)
DEFINE_FIELD_U(_xcode,             ExceptionObjectInternal,    _xcode)
DEFINE_FIELD_U(_HResult,           ExceptionObjectInternal,    _HResult)
...
DEFINE_CLASS_U(Reflection,             RuntimeExceptionHandlingClause,    RuntimeExceptionHandlingClauseInternal)
DEFINE_FIELD_U(_methodBody,            RuntimeExceptionHandlingClauseInternal,        _methodBody)
DEFINE_FIELD_U(_flags,                 RuntimeExceptionHandlingClauseInternal,        _flags)
DEFINE_FIELD_U(_tryOffset,             RuntimeExceptionHandlingClauseInternal,        _tryOffset)
DEFINE_FIELD_U(_tryLength,             RuntimeExceptionHandlingClauseInternal,        _tryLength)
DEFINE_FIELD_U(_handlerOffset,         RuntimeExceptionHandlingClauseInternal,        _handlerOffset)
DEFINE_FIELD_U(_handlerLength,         RuntimeExceptionHandlingClauseInternal,        _handlerLength)
DEFINE_FIELD_U(_catchMetadataToken,    RuntimeExceptionHandlingClauseInternal,        _catchToken)
DEFINE_FIELD_U(_filterOffset,          RuntimeExceptionHandlingClauseInternal,        _filterOffset)
...
DEFINE_CLASS_U(Reflection,             RuntimeLocalVariableInfo,        RuntimeLocalVariableInfoInternal)
DEFINE_FIELD_U(_type,                  RuntimeLocalVariableInfoInternal,        _type)
DEFINE_FIELD_U(_localIndex,            RuntimeLocalVariableInfoInternal,        _localIndex)
DEFINE_FIELD_U(_isPinned,              RuntimeLocalVariableInfoInternal,        _isPinned)
...
DEFINE_CLASS_U(Reflection,             RuntimeMethodBody,           RuntimeMethodBodyInternal)
DEFINE_FIELD_U(_IL,                    RuntimeMethodBodyInternal,         _IL)
DEFINE_FIELD_U(_exceptionHandlingClauses, RuntimeMethodBodyInternal,         _exceptionClauses)
DEFINE_FIELD_U(_localVariables,           RuntimeMethodBodyInternal,         _localVariables)
DEFINE_FIELD_U(_methodBase,               RuntimeMethodBodyInternal,         _methodBase)
DEFINE_FIELD_U(_localSignatureMetadataToken, RuntimeMethodBodyInternal,      _localVarSigToken)
DEFINE_FIELD_U(_maxStackSize,             RuntimeMethodBodyInternal,         _maxStackSize)
DEFINE_FIELD_U(_initLocals,               RuntimeMethodBodyInternal,         _initLocals)
...
DEFINE_CLASS_U(Reflection, Pointer, ReflectionPointerInternal)
DEFINE_FIELD_U(_ptr,                ReflectionPointerInternal, _ptr)
DEFINE_FIELD_U(_ptrType,            ReflectionPointerInternal, _ptrType)
...
DEFINE_CLASS_U(Diagnostics,                StackFrameHelper,   StackFrameHelperInternal)
DEFINE_FIELD_U(rgiOffset,                  StackFrameHelperInternal,   rgiOffset)
DEFINE_FIELD_U(rgiILOffset,                StackFrameHelperInternal,   rgiILOffset)
DEFINE_FIELD_U(dynamicMethods,             StackFrameHelperInternal,   dynamicMethods)
DEFINE_FIELD_U(rgMethodHandle,             StackFrameHelperInternal,   rgMethodHandle)
DEFINE_FIELD_U(rgAssemblyPath,             StackFrameHelperInternal,   rgAssemblyPath)
DEFINE_FIELD_U(rgAssembly,                 StackFrameHelperInternal,   rgAssembly)
DEFINE_FIELD_U(rgLoadedPeAddress,          StackFrameHelperInternal,   rgLoadedPeAddress)
DEFINE_FIELD_U(rgiLoadedPeSize,            StackFrameHelperInternal,   rgiLoadedPeSize)
DEFINE_FIELD_U(rgInMemoryPdbAddress,       StackFrameHelperInternal,   rgInMemoryPdbAddress)
DEFINE_FIELD_U(rgiInMemoryPdbSize,         StackFrameHelperInternal,   rgiInMemoryPdbSize)
DEFINE_FIELD_U(rgiMethodToken,             StackFrameHelperInternal,   rgiMethodToken)
DEFINE_FIELD_U(rgFilename,                 StackFrameHelperInternal,   rgFilename)
DEFINE_FIELD_U(rgiLineNumber,              StackFrameHelperInternal,   rgiLineNumber)
DEFINE_FIELD_U(rgiColumnNumber,            StackFrameHelperInternal,   rgiColumnNumber)
DEFINE_FIELD_U(rgiLastFrameFromForeignExceptionStackTrace,            StackFrameHelperInternal,   rgiLastFrameFromForeignExceptionStackTrace)
DEFINE_FIELD_U(iFrameCount,                StackFrameHelperInternal,   iFrameCount)
...
DEFINE_FIELD_U(_priority,                 ThreadBaseObjectInternal,   m_Priority)
DEFINE_FIELD_U(_isDead,                   ThreadBaseObjectInternal,   m_IsDead)
DEFINE_FIELD_U(_isThreadPool,             ThreadBaseObjectInternal,   m_IsThreadPool)
...
DEFINE_FIELD_U(_unloading,                  AssemblyLoadContextBaseObjectInternal, _unloading)
DEFINE_FIELD_U(_name,                       AssemblyLoadContextBaseObjectInternal, _name)
DEFINE_FIELD_U(_nativeAssemblyLoadContext,  AssemblyLoadContextBaseObjectInternal, _nativeAssemblyLoadContext)
DEFINE_FIELD_U(_id,                         AssemblyLoadContextBaseObjectInternal, _id)
DEFINE_FIELD_U(_state,                      AssemblyLoadContextBaseObjectInternal, _state)
DEFINE_FIELD_U(_isCollectible,              AssemblyLoadContextBaseObjectInternal, _isCollectible)
...
DEFINE_CLASS_U(System, GCMemoryInfoData, GCMemoryInfoDataInternal)
DEFINE_FIELD_U(_highMemoryLoadThresholdBytes, GCMemoryInfoDataInternal, highMemLoadThresholdBytes)
DEFINE_FIELD_U(_totalAvailableMemoryBytes, GCMemoryInfoDataInternal, totalAvailableMemoryBytes)
DEFINE_FIELD_U(_memoryLoadBytes, GCMemoryInfoDataInternal, lastRecordedMemLoadBytes)
DEFINE_FIELD_U(_heapSizeBytes, GCMemoryInfoDataInternal, lastRecordedHeapSizeBytes)
DEFINE_FIELD_U(_fragmentedBytes, GCMemoryInfoDataInternal, lastRecordedFragmentationBytes)
DEFINE_FIELD_U(_totalCommittedBytes, GCMemoryInfoDataInternal, totalCommittedBytes)
DEFINE_FIELD_U(_promotedBytes, GCMemoryInfoDataInternal, promotedBytes)
DEFINE_FIELD_U(_pinnedObjectsCount, GCMemoryInfoDataInternal, pinnedObjectCount)
DEFINE_FIELD_U(_finalizationPendingCount, GCMemoryInfoDataInternal, finalizationPendingCount)
DEFINE_FIELD_U(_index, GCMemoryInfoDataInternal, index)
DEFINE_FIELD_U(_generation, GCMemoryInfoDataInternal, generation)
DEFINE_FIELD_U(_pauseTimePercentage, GCMemoryInfoDataInternal, pauseTimePercent)
DEFINE_FIELD_U(_compacted, GCMemoryInfoDataInternal, isCompaction)
DEFINE_FIELD_U(_concurrent, GCMemoryInfoDataInternal, isConcurrent)
DEFINE_FIELD_U(_pauseDuration0, GCMemoryInfoDataInternal, pauseDuration0)
DEFINE_FIELD_U(_pauseDuration1, GCMemoryInfoDataInternal, pauseDuration1)
DEFINE_FIELD_U(_generationInfo0, GCMemoryInfoDataInternal, generationInfo0)
DEFINE_FIELD_U(_generationInfo1, GCMemoryInfoDataInternal, generationInfo1)
DEFINE_FIELD_U(_generationInfo2, GCMemoryInfoDataInternal, generationInfo2)
DEFINE_FIELD_U(_generationInfo3, GCMemoryInfoDataInternal, generationInfo3)
DEFINE_FIELD_U(_generationInfo4, GCMemoryInfoDataInternal, generationInfo4)
