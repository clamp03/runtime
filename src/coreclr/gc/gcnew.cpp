...
void mark_phase()
{
    ...
    */
    ...
    printf("[CLAMP] %s %d %p %p %p %d %p %p %p %d\n", __PRETTY_FUNCTION__, __LINE__, OLD_MEM, OLD_MEM->getCurrAddr(), IND_DIFF, IND_CURR, MEM, MEM->getCurrAddr(), IND_DIFF, IND_CURR);
