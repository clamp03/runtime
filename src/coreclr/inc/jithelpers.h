...
// It will be set in InitJITHelpers2
    ...
    DYNAMICJITHELPER(CORINFO_HELP_NGC_OBJ_BARRIER, JIT_NGC_Obj_Barrier, METHOD__NIL)
    DYNAMICJITHELPER(CORINFO_HELP_NGC_ADDR_BARRIER, JIT_NGC_Addr_Barrier, METHOD__NIL)
